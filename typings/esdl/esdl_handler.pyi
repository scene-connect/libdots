...
class EnergySystemHandler:
    ...
    def remove_obj_by_id(self, obj_id): # -> None:
        ...
    
    def get_all_instances_of_type(self, esdl_type): # -> list[Any]:
        ...
    ...
    @staticmethod
    def resolve_fragment(resource: Resource, fragment: str): # -> Any | None:
        """
...
class StringURI(URI):
    ...
    def create_instream(self): # -> BytesIO:
        ...
    
    def create_outstream(self): # -> BytesIO:
        ...
